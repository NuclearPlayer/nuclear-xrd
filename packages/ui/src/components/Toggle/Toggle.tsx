...
export const Toggle = forwardRef<HTMLButtonElement, ToggleProps>(
  (
    ...
    <HeadlessSwitch
      ...
      form={form}
      className={cn(
        'border-border relative inline-flex h-6 w-11 cursor-pointer items-center rounded-full border-2 transition-all focus:ring-2 focus:ring-black focus:ring-offset-2 focus:outline-none',
